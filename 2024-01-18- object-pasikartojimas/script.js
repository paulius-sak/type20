...
const milesPerGallon = cars.filter(car => car.Miles_per_Gallon)

console.log(milesPerGallon)

// 1.2. Parašyti komandą kuri gražins automobilius, kurie neturi "Miles_per_Gallon" ;
const milesPerGallonNot = cars.filter(car => !car.Miles_per_Gallon)
console.log(milesPerGallonNot)
...
const cylindersAndMiles = cars.filter(car => car.Miles_per_Gallon >= 15 && car.Cylinders >= 8)
...
const MadeInUsa = cars.every(car => car.Origin === 'USA')
